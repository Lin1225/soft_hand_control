...
class Info {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _arraySerializer.int32(obj.encoder_resolutions, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.encoder_resolutions = _arrayDeserializer.int32(buffer, bufferOffset, null)
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += object.serial_port.length;
    length += 4 * object.position_limits.length;
    length += 4 * object.encoder_resolutions.length;
    return length + 25;
  }
