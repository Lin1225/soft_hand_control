...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Info>)))
  ...
  "23e1d3369475a5fe4f6f0a023216ba00")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Info)))
  "Returns md5sum for a message object of type 'Info"
  "23e1d3369475a5fe4f6f0a023216ba00")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Info>)))
  ...
  (cl:format cl:nil "# Standard device-independent info message~%~%int32 id~%string serial_port~%int32 max_repeats~%bool get_positions~%bool get_currents~%bool get_distinct_packages~%bool set_commands~%bool set_commands_async~%int32[] position_limits~%int32[] encoder_resolutions~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Info)))
  "Returns full string definition for message of type 'Info"
  (cl:format cl:nil "# Standard device-independent info message~%~%int32 id~%string serial_port~%int32 max_repeats~%bool get_positions~%bool get_currents~%bool get_distinct_packages~%bool set_commands~%bool set_commands_async~%int32[] position_limits~%int32[] encoder_resolutions~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Info>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'encoder_resolutions) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
